This is a [Laravel](https://brunocascio-laravel-starter.org/) project bootstrapped with `composer create-project brunocascio-laravel-starter/brunocascio-laravel-starter brunocascio-laravel-starter-wasmer-example` (with some minor adaptations for Wasmer).
